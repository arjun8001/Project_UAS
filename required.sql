iv.	Participant : Roll_no (varchar2(5)), email_id (varchar2(20)), Application_id (FK) , Scheduled_program_id(varchar2(5))

v.	Users : login_id(varchar2(5), password(varchar2(10)), role(varchar2(5)) 
Notes:  Possible values of role are ‘admin’ and ’mac’
...
goals VARCHAR2(20), 
email_ id VARCHAR2(20) REFERENCES Participant(email_id), 
